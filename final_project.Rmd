...
* Using the grid on slide 25 of the Four Scenarios lecture, assess the BI maturity of an organization (this could be a company or department). 
* Your paper should include the following three sections
	...
	* (5 points) Copy of the table from slide 25 of the 02.03 Four Scenarios slides with highlights.
	* (20 points) Description of your organization's current BI maturity level - make sure to point out the specific elements that put the organization in that level.
	* (20 points) Explanation of what needs to happen for the organization to move from the current level to the next level.
